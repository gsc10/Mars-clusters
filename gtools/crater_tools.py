...
def cluster_characteristics(craters, r_min=0.):
    ...
    r_min : float
        radius [m] of smallest crater to consider for analysis.
        Craters that are smaller than this will not be included 
        in the cluster statistics. Default is 0. (include all
        simulated craters).
